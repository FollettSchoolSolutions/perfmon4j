...
public class ChartElementsTable extends JPanel implements
    ...
    public static void main(String[] args) throws Exception {
        RemoteManagementWrapper wrapper = RemoteManagementWrapper.open(
                "localhost", 5959);
        ...
        ChartElementsTable panel = new ChartElementsTable(manager);
        ...
        FieldKey fieldThroughputKey = getFieldByName(wrapper,
                "org.apache.catalina.connector.Request", "ThroughputPerMinute");
        manager.addOrUpdateField(new FieldElement(
                fieldThroughputKey, .01f, Color.RED));

        manager.addOrUpdateField(new FieldElement(fieldThroughputKey,
                .01f, Color.black));

        FieldKey fieldAverage = getFieldByName(wrapper,
                "org.apache.catalina.connector.Request", "AverageDuration");
        manager.addOrUpdateField(new FieldElement(fieldAverage, 1f,
                Color.RED));
