...
import war.org.perfmon4j.restdatasource.data.Database;
import war.org.perfmon4j.restdatasource.data.IntervalTemplate;
import war.org.perfmon4j.restdatasource.data.MonitoredSystem;
import war.org.perfmon4j.restdatasource.data.query.advanced.AdvancedQueryResult;
import war.org.perfmon4j.restdatasource.data.query.advanced.ResultAccumulator;
import war.org.perfmon4j.restdatasource.data.query.category.IntervalQueryResultElement;
import war.org.perfmon4j.restdatasource.data.query.category.Result;
import war.org.perfmon4j.restdatasource.data.query.category.ResultElement;
import war.org.perfmon4j.restdatasource.data.query.category.SystemResult;
import war.org.perfmon4j.restdatasource.dataproviders.IntervalDataProvider;
import war.org.perfmon4j.restdatasource.util.DataProviderRegistry;
import war.org.perfmon4j.restdatasource.util.DateTimeHelper;
import war.org.perfmon4j.restdatasource.util.ParsedSeriesDefinition;
...
//		seriesDefinition=seriesDefinition&timeStart=now-480&timeEnd=now&maxObservations=1440&seriesAlias=seriesAlias
	...
	@Produces(MediaType.APPLICATION_JSON)
	public war.org.perfmon4j.restdatasource.data.query.advanced.AdvancedQueryResult getQueryObservations(@PathParam("databaseID") String databaseID, 
