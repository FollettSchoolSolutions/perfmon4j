...
/**
 * This file is a part of  Javassist version 3
 * Copyright (C) 1999-2009 by Shigeru Chiba, All rights reserved.
 * with the following exception:
 * 		SerialVersionUID.calculateDefault() it has been rewritten to use java.io.ObjectStreamClass
 */
...
public class SerialVersionUID {
    ...
    static long calculateDefault(CtClass clazz)
        throws CannotCompileException {
    		ObjectStreamClass streamClass = ObjectStreamClass.lookup(clazz.toClass());
    		clazz.defrost();
    		
    		if (streamClass != null) {
    			return streamClass.getSerialVersionUID();
    		} else {
    			throw new CannotCompileException("Unable to calculate default serialVersionUID for class: " + clazz.getName());
    		}

/*
     		ORIGINAL CODE BODY FROM javassist project...
            try {
