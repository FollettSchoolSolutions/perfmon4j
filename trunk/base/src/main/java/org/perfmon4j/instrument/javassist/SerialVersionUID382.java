...
/**
 * This file is based on and code under the copyright of
 * Javassist, a Java-bytecode translator toolkit.
 * Copyright (C) 1999-2007 Shigeru Chiba. All Rights Reserved.
 * 
 * The original, unaltered source file can be found at:
 *    https://source.jboss.org/browse/Javassist/trunk/src/main/javassist/SerialVersionUID.java?r=382
 */
...
public class SerialVersionUID382 {
     ...
     */
    static boolean isSerializable(CtClass clazz) 
