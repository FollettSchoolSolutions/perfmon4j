...
public class FSSFetchPolicyDataProvider extends DataProvider {
	...
	private static class FSSFetchPolicy extends CategoryTemplate {
		...
		private static final Field[] buildFields() {
			...
			fields.add(new PercentProviderField("L2CacheHitPercent", "L2CACHEHITCOUNT", "L2CACHEQUERYCOUNT"));
			...
			fields.add(new PercentProviderField("L3CacheHitPercent", "L3CACHEHITCOUNT", "L3CACHEQUERYCOUNT"));
			...
			fields.add(new PercentProviderField("providerHitPercent", "PROVIDERHITCOUNT", "PROVIDERQUERYCOUNT"));
			fields.add(new PercentProviderField("providerWaivePercent", "PROVIEDRWAIVECOUNT", "PROVIDERQUERYCOUNT"));
			...
			fields.add(new ProviderField("promiseBlockedThreads", AggregationMethod.DEFAULT, AggregationMethod.SUM, "PROMISEBLOCKEDTHREADS", false));
